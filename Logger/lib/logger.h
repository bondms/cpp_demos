...
// The Flush method may be used to flush the file early and/or to check for
// flush failure; an exception can be thrown on failure.
...
// The Close method may be used to close the file early and/or to check for
// close failure; an exception can be thrown on failure.
// After Close()ing, another call to Initialise() is require if more logging is
// required.
