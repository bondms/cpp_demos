...
template <typename HandleType, void (*freeFunction)(HandleType) noexcept,
...
public:
  ...
  explicit RaiiHandle(HandleType handle) noexcept : handle_{handle} {}
  ...
  RaiiHandle(RaiiHandle &&other) noexcept : handle_{other.detach()} {}
  ...
  bool isValid() const noexcept { return invalidValue != handle_; }
  ...
  HandleType &getHandleReference() noexcept { return handle_; }
